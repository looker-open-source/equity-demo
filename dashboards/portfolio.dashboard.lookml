...
- dashboard: portfolio
  ...
  - title: Initial Investment
    ...
    fields: [portfolio_history.id, portfolio_history.price, portfolio_history.amount,
      portfolio_history.history_date_date, sum_of_available_value]
    filters:
      portfolio_history.id: "-NULL"
      portfolio_history.history_date_date: before 363 days ago
    sorts: [portfolio_history.id, portfolio_history.price, portfolio_history.amount,
      portfolio_history.history_date_date]
    subtotals: [portfolio_history.id, portfolio_history.price, portfolio_history.amount]
    limit: 500
    column_limit: 50
    total: true
    dynamic_fields:
