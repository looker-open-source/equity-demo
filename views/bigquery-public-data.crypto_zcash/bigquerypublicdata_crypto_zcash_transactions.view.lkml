...
# explore: bigquerypublicdata_crypto_zcash_transactions {
#   hidden: yes
#     join: transactions__bigquerypublicdata_crypto_zcash_inputs {
#       view_label: "Transactions: Inputs"
#       sql: LEFT JOIN UNNEST(${transactions.inputs}) as transactions__bigquerypublicdata_crypto_zcash_inputs ;;
#       relationship: one_to_many
#     }
#     join: transactions__bigquerypublicdata_crypto_zcash_outputs {
#       view_label: "Transactions: Outputs"
#       sql: LEFT JOIN UNNEST(${transactions.outputs}) as transactions__bigquerypublicdata_crypto_zcash_outputs ;;
#       relationship: one_to_many
#     }
...
#     }
# }
view: zcash_transactions {
  sql_table_name: `bigquery-public-data.crypto_zcash.transactions` ;;
...
# view: transactions__bigquerypublicdata_crypto_zcash_inputs {
...
#   }
#   dimension: transactions__bigquerypublicdata_crypto_zcash_inputs {
#     type: string
#     description: "Transaction inputs"
#     hidden: yes
#     sql: transactions__bigquerypublicdata_crypto_zcash_inputs ;;
#   }
#   dimension: type {
#     type: string
...
# view: transactions__bigquerypublicdata_crypto_zcash_outputs {
...
#     sql: script_hex ;;
#   }
#   dimension: transactions__bigquerypublicdata_crypto_zcash_outputs {
#     type: string
#     description: "Transaction outputs"
#     hidden: yes
#     sql: transactions__bigquerypublicdata_crypto_zcash_outputs ;;
#   }
#   dimension: type {
#     type: string
