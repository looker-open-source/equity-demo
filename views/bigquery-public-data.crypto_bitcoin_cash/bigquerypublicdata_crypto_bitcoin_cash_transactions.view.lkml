...
# explore: bigquerypublicdata_crypto_bitcoin_cash_transactions {
#   hidden: yes
#     join: transactions__bigquerypublicdata_crypto_bitcoin_cash_inputs {
#       view_label: "Transactions: Inputs"
#       sql: LEFT JOIN UNNEST(${transactions.inputs}) as transactions__bigquerypublicdata_crypto_bitcoin_cash_inputs ;;
#       relationship: one_to_many
#     }
#     join: transactions__bigquerypublicdata_crypto_bitcoin_cash_outputs {
#       view_label: "Transactions: Outputs"
#       sql: LEFT JOIN UNNEST(${transactions.outputs}) as transactions__bigquerypublicdata_crypto_bitcoin_cash_outputs ;;
#       relationship: one_to_many
#     }
...
#     }
# }
view: bitcoin_cash_transactions {
...
# view: transactions__bigquerypublicdata_crypto_bitcoin_cash_inputs {
...
# view: transactions__bigquerypublicdata_crypto_bitcoin_cash_outputs {
