...
# explore: bigquerypublicdata_crypto_dogecoin_outputs {
#   hidden: yes
...
#     }
# }
view: bigquerypublicdata_crypto_dogecoin_outputs {
  sql_table_name: `bigquery-public-data.crypto_dogecoin.outputs` ;;
