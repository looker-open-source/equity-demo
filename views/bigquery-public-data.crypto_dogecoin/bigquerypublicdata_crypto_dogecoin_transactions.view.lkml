...
# explore: bigquerypublicdata_crypto_dogecoin_transactions {
#   hidden: yes
#     join: transactions__bigquerypublicdata_crypto_dogecoin_inputs {
#       view_label: "Transactions: Inputs"
#       sql: LEFT JOIN UNNEST(${transactions.inputs}) as transactions__bigquerypublicdata_crypto_dogecoin_inputs ;;
#       relationship: one_to_many
#     }
#     join: transactions__bigquerypublicdata_crypto_dogecoin_outputs {
#       view_label: "Transactions: Outputs"
#       sql: LEFT JOIN UNNEST(${transactions.outputs}) as transactions__bigquerypublicdata_crypto_dogecoin_outputs ;;
#       relationship: one_to_many
#     }
...
#     }
# }
view: bigquerypublicdata_crypto_dogecoin_transactions {
  label: "Dogecoin Transactions"
  sql_table_name: `bigquery-public-data.crypto_dogecoin.transactions` ;;
...
# view: transactions__bigquerypublicdata_crypto_dogecoin_inputs {
...
#   }
#   dimension: transactions__bigquerypublicdata_crypto_dogecoin_inputs {
#     type: string
#     description: "Transaction inputs"
#     hidden: yes
#     sql: transactions__bigquerypublicdata_crypto_dogecoin_inputs ;;
#   }
#   dimension: type {
#     type: string
...
# view: transactions__bigquerypublicdata_crypto_dogecoin_outputs {
...
#     sql: ${TABLE}.script_hex ;;
#   }
#   dimension: transactions__bigquerypublicdata_crypto_dogecoin_outputs {
#     type: string
#     description: "Transaction outputs"
#     hidden: yes
#     sql: transactions__bigquerypublicdata_crypto_dogecoin_outputs ;;
#   }
#   dimension: type {
#     type: string
