...
# explore: bigquerypublicdata_crypto_dogecoin_inputs {
#   hidden: yes
...
#     }
# }
view: bigquerypublicdata_crypto_dogecoin_inputs {
  sql_table_name: `bigquery-public-data.crypto_dogecoin.inputs` ;;
